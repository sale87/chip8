...
public class Cpu
{
    ...
    private Dictionary<byte, Action<byte[]>> InitInstructions()
    {
        return new Dictionary<byte, Action<byte[]>>
        {
            { 0x0, SystemInstruction },
            { 0x1, Jump },
            { 0x2, Call },
            { 0x3, SkipIfVXeqN },
            { 0x4, SkipIfVXneqN },
            ...
            { 0x6, SetRegister },
            { 0x7, Add },
            { 0x8, LogicOrArithmeticInstruction },
            { 0x9, SkipIfVXneqVy },
